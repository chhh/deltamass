...
public class LogbackJTextPaneAppender extends AppenderBase<ILoggingEvent> {
      ...
      try {
        ...
        if (event.getLevel() == Level.ERROR) {
          textPane.getDocument()
              .insertString(textPane.getDocument().getLength(), formattedMsg, ERROR_ATT);
        } else if (event.getLevel() == Level.WARN) {
          textPane.getDocument()
              .insertString(textPane.getDocument().getLength(), formattedMsg, WARN_ATT);
        } else if (event.getLevel() == Level.INFO) {
          textPane.getDocument()
              .insertString(textPane.getDocument().getLength(), formattedMsg, INFO_ATT);
        } else if (event.getLevel() == Level.DEBUG) {
          textPane.getDocument()
              .insertString(textPane.getDocument().getLength(), formattedMsg, DEBUG_ATT);
        } else if (event.getLevel() == Level.TRACE) {
          textPane.getDocument()
              .insertString(textPane.getDocument().getLength(), formattedMsg, TRACE_ATT);
        } else {
          textPane.getDocument()
              .insertString(textPane.getDocument().getLength(), formattedMsg, OTHER_ATT);
        }
   ...
   * nothing if the model is null.  Simply does a delete if the new string is null or empty.<br>
   *
   ...
   */
  private void replaceRange(JTextPane textPane, String str, int start, int end)
