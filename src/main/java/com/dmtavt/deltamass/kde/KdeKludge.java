...
public class KdeKludge extends ContinuousDistribution
{
   ...
   * Copy constructor
   */
  private KdeKludge(double[] X, double h, double Xmean, double Xvar, double Xskew, KernelFunction k, double sumOfWeights, double[] weights)
  {
  ...
  protected double pdfPrime2(double x, int j, double h)
  {
    ...
    if (!(k instanceof KernelFuncPrime2)) {
      throw new IllegalStateException("You can only call 2nd derivative of PDF if you've set a kernel function that " +
